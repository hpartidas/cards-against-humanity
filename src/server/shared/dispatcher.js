...
export class Dispatcher {
    ...
    onRequest(typesOrCallbacks, callback = null) {
        return this.on(typesOrCallbacks, callback, A.STATUS_REQUEST);
    }

    onFail(typesOrCallbacks, callback = null) {
        return this.on(typesOrCallbacks, callback, A.STATUS_FAIL);
    }

    onSuccess(typesOrCallbacks, callback = null) {
        return this.on(typesOrCallbacks, callback, A.STATUS_SUCCESS);
    }
